...
class LaporanController extends Controller
{
    ...
    public function stok(Request $request)
    {
        ...
        $pdf = Pdf::loadView('laporan.stok', [
            ...
            'namaSekolah'       => $this->namaSekolah(),
            'keteranganPeriode' => $namaKategori
    ...
    // =========================================================
    // FITUR EXCEL (OTOMATIS DOWNLOAD TANPA COMPOSER)
    // =========================================================
    ...
    public function exportPeminjaman(Request $request)
    {
        ...
        $view = view('laporan.excel.peminjaman', [
            'daftarPeminjaman'  => $daftarPeminjaman,
            'namaSekolah'       => $this->namaSekolah(),
            'keteranganPeriode' => $this->keteranganPeriode($data),
        ])->render();
    ...
    public function exportPengembalian(Request $request)
    {
        ...
        $view = view('laporan.excel.pengembalian', [
            'daftarPengembalian' => $daftarPengembalian,
            'totalDenda'         => $daftarPengembalian->sum('total_denda'),
            'namaSekolah'        => $this->namaSekolah(),
            'keteranganPeriode'  => $this->keteranganPeriode($data),
        ...
        $filename = 'laporan-pengembalian-denda-' . date('Y-m-d') . '.xls';
    ...
    public function exportStok(Request $request)
    {
        ...
        $view = view('laporan.excel.stok', [
            'daftarAlat'        => $daftarAlat,
            'namaSekolah'       => $this->namaSekolah(),
            'keteranganPeriode' => $namaKategori . ' — per ' . now()->format('d/m/Y'),
        ])->render();

        $filename = 'laporan-rekapitulasi-stok-' . date('Y-m-d') . '.xls';
