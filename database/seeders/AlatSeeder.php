...
class AlatSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $daftarAlat = [
            ...
            ['kode_alat' => 'PKT-002', 'nama' => 'Tang Kombinasil',         'kategori' => 'Perkakas Tangan', 'stok' => 8],
            ...
            ['kode_alat' => 'JAR-001', 'nama' => 'Proyektor Portabel',     'kategori' => 'Perangkat Audio Visual', 'stok' => 3],
            ['kode_alat' => 'JAR-002', 'nama' => 'Tripod Kamera',          'kategori' => 'Perangkat Audio Visual', 'stok' => 6],
            ['kode_alat' => 'JAR-003', 'nama' => 'Kamera Mirrorless',      'kategori' => 'Perangkat Audio Visual', 'stok' => 2],
        ];
